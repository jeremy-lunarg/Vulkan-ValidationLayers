...
TEST_F(VkLayerTest, DrawWithoutUpdatePushConstants) {
    ...
    char const *const vsSource =
        ...
        "   mat3 m3 = constants.m; \n"
        // index of f2 is variable. It's skipped in used verity.
        "   for(int i=0;i<3;++i) {\n"
        "      float f = constants.f2[i]; \n"
        "   }\n"
        "}\n";

    // push constant range: 0 - 95, used: 32 - 47
    char const *const fsSource =
        ...
        "void main(){\n"
        "   f = constants.s;\n"
        // index of ss is variable. It's skipped in used verity.
        "   for(int i=0;i<3;++i) {\n"
        "      foo1 f = constants.ss[i]; \n"
        "   }\n"
        "}\n";
